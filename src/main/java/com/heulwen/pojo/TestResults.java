...
@NamedQueries({
    ...
    @NamedQuery(name = "TestResults.findByScore", query = "SELECT t FROM TestResults t WHERE t.score = :score"),
    @NamedQuery(name = "TestResults.findByDateTaken", query = "SELECT t FROM TestResults t WHERE t.dateTaken = :dateTaken")})
public class TestResults implements Serializable {
    ...
    public String toString() {
        return "com.heulwen.pojo.TestResults[ id=" + id + " ]";
    }
